...
class PacientesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create paciente" do
    assert_difference('Paciente.count') do
      post pacientes_url, params: { paciente: { email: @paciente.email, nome: @paciente.nome, problema: @paciente.problema } }
    end
  ...
  test "should update paciente" do
    patch paciente_url(@paciente), params: { paciente: { email: @paciente.email, nome: @paciente.nome, problema: @paciente.problema } }
